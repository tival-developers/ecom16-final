        ...
        <div className='bg-slate-50 sticky top-0 z-50 p-4 sm:p-6 border-b'>
          ...
          >
            <TabsList className='flex flex-wrap gap-2'>
              ...
              <TabsTrigger value='promoMini'>Promo Mini</TabsTrigger>
              <TabsTrigger value='promoLarge'>Promo Large</TabsTrigger>
            </TabsList>
          </Tabs>
        </div>
                ...
                {paginatedBanners.map((banner) => (
                  ...
                  >
                    ...
                    <CardContent className='px-2 py-1 flex flex-col flex-grow'>
                      ...
                      <p className='text-base  font-semibold mb-1 line-clamp-1'>
                        {banner.subtitle}
                      </p>
